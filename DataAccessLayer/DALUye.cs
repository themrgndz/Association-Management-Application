...
namespace DataAccessLayer
{
    public class DALUye
    {
        ...
        public static List<EntityUye> UyeListesi()
        {
            ...
            OleDbCommand cmd = new OleDbCommand("SELECT * FROM Uye", Baglanti.dbc);
        ...
        {
            OleDbCommand cmd2 = new OleDbCommand("INSERT INTO Uye(Tc,Ad,Soyad,Yas,Sehir,Sifre,KanGrubu,AktifPasif,Borc) VALUES (@P1,@P2,@P3,@P4,@P5,@P6,@P7,@P8,@P9)", Baglanti.dbc);
        ...
        {
            OleDbCommand cmd3 = new OleDbCommand("DELETE * FROM Uye WHERE Tc = @P1", Baglanti.dbc);
        ...
        {
            OleDbCommand cmd4 = new OleDbCommand("UPDATE Uye SET Ad = @P1, Soyad = @P2, Yas = @P3, Sehir = @P4, Sifre = @P5, KanGrubu = @P6, AktifPasif = @P7, Borc = @P8 WHERE Tc = @P9", Baglanti.dbc);
        ...
        public static bool YoneticiDogrula(string tc, string sifre)
        {
            ...
            OleDbCommand cmd5 = new OleDbCommand("SELECT * FROM Yonetici", Baglanti.dbc);
            try
            {
        ...
        {
            bool dogrulandi = false;
            OleDbCommand cmd5 = new OleDbCommand("SELECT * FROM Uye", Baglanti.dbc);
            try
            {
                if (cmd5.Connection.State != ConnectionState.Open)
                {
